...
<div class="row" style="margin-top:40px;">
	...
	<div class="well well-sm">
        ...
        <div class="row" id="post-review-box" style="display:none;">
            <div class="col-md-12">
                <form action="${pageContext.request.contextPath}/userReview" method="POST">
                    <input id="ratings-hidden" name="rating" type="hidden"> 
                    <textarea class="form-control animated" cols="50" id="new-review" name="comment" placeholder="Enter your ${shoppingCart.name} review here..."   rows="5"></textarea>
    				<input type="hidden" name="code" value="${shoppingCart.code}" />
    				<input type="hidden" name="name" value="${shoppingCart.name}" />
    				<input type="hidden" name="manufacturer" value="${shoppingCart.manufacturer}" />
                    <div class="text-right">
